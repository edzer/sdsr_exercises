...
line, we would expect a residual standard error similar to
```{r}
sd(runif(1000, min = -.0005, max = .0005))
```
...
A further "red flag" that counts against the constant (1e10) conversion
...
these residuals clearly showh a North-South trend, corresponding
